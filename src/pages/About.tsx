...
const milestones = [
  ...
  { year: "2012", event: "Расширение парка до 20 единиц. Выход в Аксай и Батайск." },
      ...
      <section className="bg-brand-black py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <p className="text-brand-gray-light text-xl max-w-2xl leading-relaxed">
            С 2009 года мы доставляем строительные материалы, предоставляем спецтехнику и вывозим мусор в Ростове-на-Дону, Аксае и Батайске.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-brand-gray-mid leading-relaxed mb-5">
                РостовТехРезерв — это не просто транспортная компания. Это команда профессионалов, которые понимают строительный бизнес изнутри. Каждый наш сотрудник знает, что стройка не ждёт.
              </p>
